			...
			<div class="col-md-12">
				<div class="card card-style">
					...
					<div class="row">
						...
						<p class="fs-3 text-center pt-3">View Patients</p>
						</div>
						...
						<table class="table table-striped table-hover" id="data-table">
							...
							<tbody>
								...
								<tr>
									...
									<td><%=p.getAddress() %></td>
									<td><%=p.getPhoneNo() %></td>
									<td><a class=" text-white fs-5 btn btn-success" role="button" href="patient_history.jsp?patient_id=<%=p.getId()%>"><i class="fa-solid fa-eye"></i>View</a></td>
									<td>
										<a href="update_patient.jsp?id=<%=p.getId() %>" class="btn btn-success" role="button"><span><i class="fa-regular fa-pen-to-square"></i></span> Edit</a>
...
<script>
    ...
    function showAlertAndSubmit(){
   	 ...
   	 document.getElementById("patientId").value = itemId;
   }
</script>
